...
WebUI.click(findTestObject('Object Repository/Uworld Objects/Page_UWorld USMLE/a_Welcome'))

WebUI.click(findTestObject('Object Repository/Uworld Objects/Page_UWorld STEP1 QBank/a_Create Test'))

WebUI.click(findTestObject('Object Repository/Uworld Objects/Page_UWorld STEP1 QBank/ins_Subjects_iCheck-helper'))

WebUI.click(findTestObject('Object Repository/Uworld Objects/Page_UWorld STEP1 QBank/ins_Systems_iCheck-helper'))

WebUI.setText(findTestObject('Object Repository/Uworld Objects/Page_UWorld STEP1 QBank/input_No. of Questions_questionCount'), 
    '10')

WebUI.click(findTestObject('Object Repository/Uworld Objects/Page_UWorld STEP1 QBank/input_Max allowed per block_btn btn-primary_ad16b0'))
